      ...
      <Container>
        <div className="py-28 flex flex-col lg:flex-row items-center">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/2">
            <a
              href="https://chromewebstore.google.com/detail/rockit-fancy-text-generat/lbbfbphfcolgniflkglblkmkghbceknp"
            ...
            <a
              href="https://addons.mozilla.org/en-GB/firefox/addon/rockit-fancy-text-generator/"
              className="mx-3 bg-black hover:bg-white hover:text-black border border-black text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0 text-center"
            >
